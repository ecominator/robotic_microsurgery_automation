/**********************************************************************
* Copyright (c) 2006-2019 SmarAct GmbH
*
...
#define SA_MCSCONTROL_VERSION_MAJOR                 3
#define SA_MCSCONTROL_VERSION_MINOR                 0
#define SA_MCSCONTROL_VERSION_UPDATE                31
...
#define SA_COMPATIBILITY_ERROR                      25
#define SA_NO_SUCH_SLAVE_ERROR                      128
...
#define SA_CALIBRATION_FAILED_ERROR                 160
...
#define SA_REFERENCE_SIGNAL                         7
#define SA_POWER_SUPPLY                             11
#define SA_SCALE                                    22
#define SA_ANALOG_AUX_SIGNAL                        23
#define SA_QUIET_MODE                               24
...
#define SA_OFFSET                                   47
#define SA_DISTANCE_TO_REF_MARK                     48
#define SA_REFERENCE_SPEED                          49
...
#define SA_SCT_SENSOR_TYPE                          35
#define SA_SR77T_SENSOR_TYPE                        36
#define SA_SR120_SENSOR_TYPE                        37
#define SA_LC_SENSOR_TYPE                           38
#define SA_LR_SENSOR_TYPE                           39
#define SA_LCD_SENSOR_TYPE                          40
#define SA_L_SENSOR_TYPE                            41
#define SA_LD_SENSOR_TYPE                           42
#define SA_LE_SENSOR_TYPE                           43
#define SA_LED_SENSOR_TYPE                          44
#define SA_GDD_SENSOR_TYPE                          45
#define SA_GED_SENSOR_TYPE                          46
#define SA_G935S_SENSOR_TYPE                        47
#define SA_G605DS_SENSOR_TYPE                       48
#define SA_G775DS_SENSOR_TYPE                       49
#define SA_G605L_SENSOR_TYPE                        50
#define SA_G775L_SENSOR_TYPE                        51
#define SA_G935L_SENSOR_TYPE                        52
#define SA_G605LE_SENSOR_TYPE                       53
#define SA_G775LE_SENSOR_TYPE                       54
#define SA_G935LE_SENSOR_TYPE                       55
#define SA_SI160_SENSOR_TYPE                        56
...
#define SA_POSITIONER_TYPE_PACKET_TYPE              22
...
#define SA_INVALID_SYSTEM_INDEX                     -1

// positioner type info properties
#define SA_MOVEMENT_TYPE_POS_INFO                   1
#define SA_REFERENCE_TYPE_POS_INFO                  2

// movement types
#define SA_LINEAR_MOVEMENT_TYPE                     0
#define SA_ROTATORY_MOVEMENT_TYPE                   1

// reference types
#define SA_NO_REF_TYPE                              0
#define SA_END_STOP_REF_TYPE                        1
#define SA_SINGLE_CODED_REF_TYPE                    2
#define SA_DISTANCE_CODED_REF_TYPE                  3
...
MCSCONTROL_API
SA_STATUS MCSCONTROL_CC SA_GetPositionerTypeList(SA_INDEX systemIndex, unsigned int *typesList, unsigned int *typesListSize);

MCSCONTROL_API
SA_STATUS MCSCONTROL_CC SA_GetPositionerTypeName(SA_INDEX systemIndex, unsigned int type, char *outBuffer, unsigned int *ioBufferSize);

MCSCONTROL_API
SA_STATUS MCSCONTROL_CC SA_GetPositionerTypeProperty(SA_INDEX systemIndex, unsigned int type, unsigned int key, unsigned int *value);
...
MCSCONTROL_API // Positioner
SA_STATUS MCSCONTROL_CC SA_GetPositionerType_S(SA_INDEX systemIndex, SA_INDEX channelIndex, unsigned int *type);
...
MCSCONTROL_API // Positioner
SA_STATUS MCSCONTROL_CC SA_GetPositionerType_A(SA_INDEX systemIndex, SA_INDEX channelIndex);
